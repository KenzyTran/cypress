...
describe('Kiểm tra số liệu nước ngoài ở trang Phân Tích Cơ Bản', () => {
    ...
    const stockData = [
      { stockcode: 'VIC', expectedValue: '10.14%' },
      { stockcode: 'PVS', expectedValue: '20.71%' },
      { stockcode: 'OIL', expectedValue: '6.34%' }
    ];
    ...
    stockData.forEach(({ stockcode, expectedValue }) => {
      it(`Kiểm tra mã ${stockcode} với giá trị sở hữu nước ngoài là ${expectedValue}`, () => {
        // Đăng nhập lại
        login();
